...
public class RigidbodyParticleWind : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        myRigidbody.AddTorque(transform.right * 150, ForceMode.Force);
        //myRigidbody.AddForce(new Vector3(particles[0].velocity.x, particles[0].velocity.y, particles[0].velocity.z)); 
